...
// String2Int string convert int
func String2Int(intStr string) (intNum int) {
	intNum, _ = strconv.Atoi(intStr)
	return
}

// String2Int64 string convert int64
...
// String2Float64 string convert float64
func String2Float64(floatStr string) (floatNum float64) {
	floatNum, _ = strconv.ParseFloat(floatStr, 64)
	return
}

// String2Float32: string convert float32
...
// Int2String: int convert intStr
func Int2String(intNum int) (intStr string) {
	intStr = strconv.Itoa(intNum)
	return
}

// Int642String: int64 convert string
...
// Float32ToString: float32 to string
// floatNum : 待转化数字
// prec : 精度位数 (不传则默认float数字精度)
